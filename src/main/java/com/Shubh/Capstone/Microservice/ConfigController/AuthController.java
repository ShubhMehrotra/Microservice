package com.Shubh.Capstone.Microservice.ConfigController;
...
import com.Shubh.Capstone.Microservice.Payload.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(
        ...
        if(client.getRefreshToken()!=null)
        {
            ...
            logger.warn("Refresh token is null for user email id: {}", user.getEmail());
